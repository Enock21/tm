...
class SUserProfile extends StatefulWidget {
  const SUserProfile({super.key});

  @override
  _SUserProfileState createState() => _SUserProfileState();
}

class _SUserProfileState extends State<SUserProfile> {
        ...
        child: Padding(
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                // Cabeçalho
                const CHeader(title: 'Meu Perfil de Usuário'),
                ...
                TMButton.positive(
                  ...
                  onPressed: () async {
                    ...
                    WidgetsBinding.instance.addPostFrameCallback((_) {
                      print(
                          'Dentro de WidgetsBinding.instance.addPostFrameCallback');
