...
void main() {
  group('Tela de Cadastro - Validações', () {
    testWidgets('SR1-TST1: Exibe erro quando o formato do username é inválido',
        (tester) async {
    ...
    testWidgets('SR1-TST2: Exibe erro quando o username já está cadastrado',
        (tester) async {
      await tester.pumpWidget(const MaterialApp(home: SR1UserProf()));
    ...
    testWidgets('SR1-TST3: Exibe erro quando o e-mail já está cadastrado',
        (tester) async {
      await tester.pumpWidget(const MaterialApp(home: SR1UserProf()));
    ...
    testWidgets('SR1-TST4: Exibe erro quando o formato do e-mail é inválido',
        (tester) async {
      await tester.pumpWidget(const MaterialApp(home: SR1UserProf()));
    ...
    testWidgets('SR1-TST5: Exibe erro quando o campo de e-mail está vazio',
        (tester) async {
      await tester.pumpWidget(const MaterialApp(home: SR1UserProf()));
    ...
    testWidgets('SR1-TST6: Exibe erro quando o campo de username está vazio',
        (tester) async {
      await tester.pumpWidget(const MaterialApp(home: SR1UserProf()));
    ...
    testWidgets('SR1-TST7: Exibe erro quando o campo de senha está vazio',
        (tester) async {
      await tester.pumpWidget(const MaterialApp(home: SR1UserProf()));
    ...
    testWidgets('SR1-TST8: Exibe erro quando o campo de confirmação de senha está vazio',
        (tester) async {
      await tester.pumpWidget(const MaterialApp(home: SR1UserProf()));
    ...
    testWidgets('SR1-TST9: Exibe erro quando as senhas não coincidem', (tester) async {
      await tester.pumpWidget(const MaterialApp(home: SR1UserProf()));
